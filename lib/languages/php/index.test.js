...
const dependenciesFixture = fs
  .readFileSync(path.join(__dirname, "./__fixtures__/popular.html"))
  .toString();
const dependencyFixture = require("./__fixtures__/api.json");
const php = require(".");

fetchMock.get(
  "glob:https://packagist.org/explore/popular",
  dependenciesFixture
);
fetchMock.get("glob:https://packagist.org/packages/*", dependencyFixture);
